...
import { LayoutDashboard, ListChecks, PieChart, Target, AlertTriangle, BrainCircuit, Replace, Settings } from "lucide-react"
    ...
    <SidebarProvider>
      <div className="flex min-h-screen flex-col">
        ...
        <div className="container mx-auto flex-1 items-start md:grid md:grid-cols-[240px_minmax(0,1fr)] md:gap-6 lg:grid-cols-[280px_minmax(0,1fr)] lg:gap-10">
          <aside className="fixed top-16 z-30 -ml-2 hidden h-[calc(100vh-4rem)] w-full shrink-0 md:sticky md:block md:w-auto">
            <ScrollArea className="h-full py-6 pr-6 lg:py-8">
              <SidebarNav items={navItems} />
            </ScrollArea>
          </aside>
          <main className="relative py-6 lg:py-8 md:pl-4">
            {children}
          </main>
        </div>
      </div>
