can you once again validate the entities design that you've build against each and every view and double-check each and every view is possible to build, there is sufficient data and sufficient ways for the user to manage it:
...
please respond in russian. verify each and every view and give very short and concise answers. if something is missing in the model, please think what else is needed and suggest solutions or options, but stay in line with non-functional requirements (simplicity, ease to manage, ease to understand, etc). please respond in russian.